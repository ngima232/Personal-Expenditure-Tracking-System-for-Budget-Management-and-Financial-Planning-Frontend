...
function TopNavbar({ user, logout }) {
  ...
  const pageTitle =
    PAGE_TITLES[location.pathname] || 'PETS';
    ...
    <header className="flex h-16 shrink-0 items-center justify-between border-b border-line bg-paper-card px-6 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="font-display text-base font-medium text-text-ink">
            PETS
          </p>
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          >
            ...
            <span className="hidden text-sm font-medium text-text-ink sm:inline">
              {user?.name}
            </span>
          ...
          {menuOpen && (
            ...
            <div className="absolute right-0 top-full z-50 mt-2 w-64 overflow-hidden rounded-md border border-line bg-paper-card shadow-lg">
              ...
              <button
                ...
                className="flex w-full items-center justify-between border-b border-line px-4 py-3 text-left transition-colors hover:bg-paper"
              >
              ...
              <button
                type="button"
                onClick={handleOpenProfile}
                className="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-text-muted transition-colors hover:bg-paper hover:text-text-ink"
              >
              ...
              <button
                ...
                className="flex w-full items-center gap-2 border-t border-line px-4 py-2.5 text-sm text-text-muted transition-colors hover:bg-paper hover:text-expense"
              >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="flex h-full w-60 shrink-0 flex-col overflow-y-auto border-r border-line bg-ink text-paper-card">
          ...
          <div className="px-6 py-6">
            ...
            <p className="font-display text-xl font-medium tracking-tight text-paper-card">
              PETS
            </p>

            <p className="mt-0.5 text-xs text-paper-card/50">
          ...
          <div className="shrink-0 border-t border-paper-card/10 px-4 py-4 sm:hidden">
            ...
            <p className="truncate px-2 text-sm text-paper-card/80">
              {user?.name}
            </p>

            <p className="truncate px-2 text-xs text-paper-card/40">
              {user?.email}
            </p>
